...
(() => {
  ...
  const MSG = {
    ...
    "import.chunkSize":   { zh: "切分字數", en: "Chunk size", ru: "Размер фрагмента" },
    "import.chunkOverlap":{ zh: "重疊字數", en: "Overlap", ru: "Перекрытие" },
    "import.maxChunks":   { zh: "最大片段", en: "Max chunks", ru: "Макс. фрагментов" },
    "import.indexConcurrency":{ zh: "併發索引", en: "Index concurrency", ru: "Параллельная индексация" },
    "import.aiCompress":  { zh: "AI 壓縮", en: "AI compress", ru: "AI-сжатие" },
    "import.aiProviderDefault":{ zh: "使用目前 LLM", en: "Use current LLM", ru: "Текущий LLM" },
    "import.aiTargetChars":{ zh: "總結字數", en: "Summary chars", ru: "Символов в сводке" },
    "import.button":      { zh: "匯入伺服器路徑", en: "Import server path", ru: "Импорт пути сервера" },
    "import.chooseFiles": { zh: "選擇檔案", en: "Choose Files", ru: "Выбрать файлы" },
    "import.uploadButton":{ zh: "上傳匯入", en: "Upload import", ru: "Загрузить и импортировать" },
    "import.advanced":    { zh: "進階：從伺服器路徑匯入", en: "Advanced: import from server path", ru: "Дополнительно: импорт пути сервера" },
    "import.hint":        { zh: "先選擇本機 .md、.markdown、.txt 或 LivingMemory .json，然後按「上傳匯入」。", en: "Choose local .md, .markdown, .txt, or LivingMemory .json files, then click Upload import.", ru: "Выберите локальные .md, .markdown, .txt или LivingMemory .json файлы, затем нажмите загрузку." },
    "import.running":     { zh: "正在匯入文件...", en: "Importing documents...", ru: "Импорт документов..." },
    "import.uploading":   { zh: "正在上傳文件...", en: "Uploading documents...", ru: "Загрузка документов..." },
    "import.busy":        { zh: "文件匯入或上傳仍在執行中", en: "Document import or upload is still running", ru: "Импорт или загрузка документов еще выполняется" },
    "import.progressIdle":{ zh: "準備就緒", en: "Ready", ru: "Готово" },
    "import.progressQueued":{ zh: "匯入任務已建立", en: "Import job queued", ru: "Задача импорта поставлена в очередь" },
    "import.progressRunning":{ zh: "匯入進行中", en: "Import in progress", ru: "Импорт выполняется" },
    "import.progressAiIndexing":{ zh: "AI 壓縮完成，正在產生 embedding 並寫入索引", en: "AI compression complete, generating embeddings and writing index", ru: "AI-сжатие завершено, создаются embedding и записывается индекс" },
    "import.progressComplete":{ zh: "匯入完成", en: "Import complete", ru: "Импорт завершен" },
    "import.jobMissing":  { zh: "匯入任務未建立", en: "Import job was not created", ru: "Задача импорта не создана" },
    ...
    "import.uploadFail":   { zh: "文件上傳失敗", en: "Document upload failed", ru: "Ошибка загрузки документов" },
    ...
    "import.filesRequired":{ zh: "請選擇要上傳的 .md、.txt 或 LivingMemory .json 文件", en: "Choose .md, .txt, or LivingMemory .json files to upload", ru: "Выберите .md, .txt или LivingMemory .json файлы для загрузки" },
    ...
    "import.selectedTitle":{ zh: "已選檔案", en: "Selected files", ru: "Выбранные файлы" },
    "import.selectedTitleWithCount":{ zh: "已選 {0} 個可上傳檔案", en: "{0} uploadable files selected", ru: "Выбрано файлов для загрузки: {0}" },
    "import.selectedTitleWithSkipped":{ zh: "已選 {0} 個可上傳檔案，{1} 個不支援", en: "{0} uploadable files selected, {1} unsupported", ru: "Выбрано для загрузки: {0}, неподдерживаемых: {1}" },
    "import.fileReady":   { zh: "可上傳", en: "Ready", ru: "Готово" },
    "import.fileUnsupported":{ zh: "不支援", en: "Unsupported", ru: "Не поддерживается" },
    "import.unnamedFile": { zh: "未命名檔案", en: "Unnamed file", ru: "Без имени" },
    ...
    "export.formatJson":  { zh: "JSON", en: "JSON", ru: "JSON" },
    "export.formatMarkdown":{ zh: "Markdown", en: "Markdown", ru: "Markdown" },
    "export.running":     { zh: "正在匯出記憶...", en: "Exporting memories...", ru: "Экспорт памяти..." },
    "export.success":     { zh: "已匯出 {0} 條記憶", en: "Exported {0} memories", ru: "Экспортировано записей: {0}" },
    "export.empty":       { zh: "沒有可匯出的記憶", en: "No memories to export", ru: "Нет памяти для экспорта" },
    "export.fail":        { zh: "匯出失敗", en: "Export failed", ru: "Ошибка экспорта" },
