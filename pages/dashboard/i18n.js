...
(() => {
  ...
  const MSG = {
    ...
    "import.hint":        { zh: "可填伺服器/容器路徑匯入，或選擇本機 .md、.markdown、.txt 上傳。", en: "Import from a server/container path, or choose local .md, .markdown, .txt files to upload.", ru: "Импортируйте путь сервера/контейнера или загрузите локальные .md, .markdown, .txt файлы." },
