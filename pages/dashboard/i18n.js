...
(() => {
  ...
  const MSG = {
    ...
    "import.uploadButton":{ zh: "上傳", en: "Upload", ru: "Загрузить" },
    "import.hint":        { zh: "可填伺服器/容器路徑匯入，或選擇本機 .md、.markdown、.txt、LivingMemory .json 上傳。", en: "Import from a server/container path, or choose local .md, .markdown, .txt, or LivingMemory .json files to upload.", ru: "Импортируйте путь сервера/контейнера или загрузите локальные .md, .markdown, .txt либо LivingMemory .json файлы." },
